...
# - Training with a lower learning rate and higher minibatch size as in the scVIVA tutorial
...
output_dir = jpascvi.create_output_dir(PARENT_DIR, 'scviva_2', change_dir=True)
