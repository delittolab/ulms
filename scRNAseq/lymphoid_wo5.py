...
# # scVI integration of only the T cells, B cells, Plasma cells, and NK cells for the revision after removing sample05 (spleen)
...
output_dir = jpascvi.create_output_dir(PROJECT_DIR, 'lymphoid_wo5', change_dir=True)
